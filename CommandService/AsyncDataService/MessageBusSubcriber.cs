...
namespace CommandService.AsyncDataService
{
    public class MessageBusSubcriber : BackgroundService
    {
        ...
        public MessageBusSubcriber(IConfiguration configuration, IEventProcessor processor)
        {
        ...
        private void InitializeRabbitMQ()
        {
            ...
            {
                Console.WriteLine($"could not initialize message bus listener: {ex.Message}");
            }
        }
